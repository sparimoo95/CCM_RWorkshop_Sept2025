...
setwd("/Users/shireenparimoo/Documents/Teaching/R Workshop - September 2025/data/")
...
ggplot(prepped_df, aes(x = factor(TenYearCHD, labels = c("No HD", "HD")), y = cigsPerDay, fill = TenYearCHD)) +
