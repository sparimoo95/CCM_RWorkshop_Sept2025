...
setwd("/Users/shireenparimoo/Downloads/CCM_RWorkshop_Sept2025-main/data/")


## 00. Load libraries ----------------------------------------------------

install.packages("tidyverse", "jtools", "stats", "sjPlot", "corrplot")
...
prepped_df_base <- dplyr::mutate(prepped_df_base, 
